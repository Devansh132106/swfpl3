...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C6QaRMUl.mjs");
...
const manifest = {
  "788cb3f044dc896b914af7d4d5649f1a6496e105be9fe6f6d2c466419caf549f": {
    ...
    importer: () => import("./players.fn-CM0qBAa2.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-gBAoY8fN.mjs").then((n) => n.r),
    import("./start-BlvoQEaO.mjs"),
