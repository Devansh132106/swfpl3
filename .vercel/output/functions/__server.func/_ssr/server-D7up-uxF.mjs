...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CE-Hqw6n.mjs");
...
const manifest = {
  "788cb3f044dc896b914af7d4d5649f1a6496e105be9fe6f6d2c466419caf549f": {
    functionName: "loadPlayers_createServerFn_handler",
    importer: () => import("./players.fn-6IJ9UWlE.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BUqAvXv2.mjs").then((n) => n.r),
    import("./start-Cxhw92cv.mjs"),
