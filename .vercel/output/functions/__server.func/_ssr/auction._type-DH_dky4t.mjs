...
import { R as Route$1, S as SHEETS, A as AUCTION_META, l as loadPlayers } from "./router-dMXCBmTf.mjs";
import { e as eligibleTeams, G as GROUP_LABELS, b as effectiveMaxPlayers, g as getAuctionRules, a as getTeamsForAuction, P as PLAYER_BASE_PRICE, r as resolveNextIndex, v as validateBid, c as eligibleLotteryTeams, f as findFirstInGroup, d as findFirstAvailable } from "./preparePlayers-Dj3YE9zo.mjs";
...
const KEY = (auction) => `auction-state-v3:${auction}`;
function applyBasePrice(players, basePrice) {
  return players.map((p) => ({ ...p, basePrice }));
}
function mergeWithCache(initialPlayers, cached) {
...
function useAuctionState(auction, initialPlayers, teams, rules) {
  ...
  const pricedInitial = reactExports.useMemo(
    () => applyBasePrice(initialPlayers, basePrice),
    [initialPlayers, basePrice]
  );
  const [players, setPlayers] = reactExports.useState(pricedInitial);
  ...
  const reset = reactExports.useCallback(() => {
    const fresh = pricedInitial.map((p) => ({ ...p, status: "AVAILABLE", soldPrice: null, team: null }));
    setPlayers(fresh);
    setHistory([]);
    setActiveGroup(initialGroup(rules));
    setAuctionRound(1);
...
function PlayerDetailsHeader({ player, basePrice }) {
...
function rotationForSegment(index, total) {
  const seg = 360 / total;
...
function LotteryWheel({ currentPlayer, players, teams, teamStats, rules, onAssign }) {
  ...
  const spin = () => {
    ...
    if (!player || spinning || eligibleTeams2.length === 0) return;
    setSpinning(true);
    setResult(null);
    const picked = eligibleTeams2[Math.floor(Math.random() * eligibleTeams2.length)];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto flex max-w-lg flex-col items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-20 -mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto h-0 w-0 border-x-[14px] border-x-transparent border-t-[22px] border-t-[oklch(0.85_0.18_85)] drop-shadow-lg" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative rounded-full p-1 shadow-2xl ring-4 ring-white/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "text",
                  {
                    ...
                    opacity: full ? 0.5 : 1,
                    children: t.name.length > 12 ? t.name.split(" ")[0] : t.name
                  }
                )
              ] }, t.id);
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: CX, cy: CY, r: 28, fill: "oklch(0.15 0.02 260)", stroke: "white", strokeWidth: 3 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: CX, y: CY, fill: "white", fontSize: 11, fontWeight: "bold", textAnchor: "middle", dominantBaseline: "middle", children: "SPIN" })
          ] })
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.button,
        {
          ...
          whileTap: { scale: 0.97 },
          disabled: spinning || eligibleTeams2.length === 0 || !currentPlayer,
          onClick: spin,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-3 text-center text-xs text-muted-foreground", children: [
        remaining.length,
        " players remaining · pointer selects the team"
      ] })
    ] }),
...
function LiveBar({ player, currentBid, basePrice, lotteryMode }) {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          player?.group && /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { label: "Group", value: GROUP_LABELS[player.group]?.replace("Group ", "") ?? player.group }),
          !lotteryMode && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { label: "Base Price", value: `₹${basePrice.toLocaleString()}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { label: "Current Bid", value: currentBid ? `₹${currentBid.toLocaleString()}` : "—" })
          ] }),
          lotteryMode && player && /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { label: "Status", value: player.status === "AVAILABLE" ? "Up Next" : player.status }),
          !lotteryMode && /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { label: "Sold To", value: player?.team ?? "—" })
        ]
      },
      player?.id ?? "none"
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-start gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            (team.captain || team.mentor) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-muted-foreground truncate", children: [
              team.captain && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                "C: ",
                team.captain
              ] }),
              team.captain && team.mentor && " · ",
              team.mentor && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                "M: ",
                team.mentor
              ] })
            ] })
...
function TeamModal({ open, team, players, spent, hidePurse, onClose }) {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center gap-4 border-b border-white/10 p-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              ...
              (team.captain || team.mentor) && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                team.captain && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  "Captain: ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-xl border border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
                players.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 3, className: "px-3 py-6 text-center text-muted-foreground", children: "No players yet." }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: `grid gap-2 border-t border-white/10 p-6 ${hidePurse ? "grid-cols-1" : "grid-cols-3"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Total Players", value: players.length }),
            !hidePurse && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
...
function AuctionFloor({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative min-h-screen overflow-x-hidden stadium-bg", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto max-w-[1600px] px-4 py-4 lg:px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LiveBar, { player: currentPlayer, currentBid: rules.lotteryMode ? null : Number(soldPrice) || null, basePrice: rules.basePrice, lotteryMode: rules.lotteryMode }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid grid-cols-1 gap-4 xl:grid-cols-3 xl:items-start", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-4", children: [
          rules.lotteryMode ? /* @__PURE__ */ jsxRuntimeExports.jsx(LotteryWheel, { currentPlayer, players, teams, teamStats, rules, onAssign: assignLottery }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PlayerDetailsHeader, { player: currentPlayer, basePrice: rules.basePrice }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-2xl p-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3 md:grid-cols-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Field, { label: "Team", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: teamName, onChange: (e) => setTeamName(e.target.value), className: "w-full rounded-lg bg-white px-3 py-2 text-black outline-none focus:ring-2 focus:ring-[oklch(0.78_0.22_150)]", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", className: "text-black", children: "Select team…" }),
                    eligible.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: t.name, className: "text-black", children: t.name }, t.id))
                  ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(TeamModal, { open: !!modalTeam, team: modalTeam, players: modalTeam ? teamStats.get(modalTeam.name)?.players ?? [] : [], spent: modalTeam ? teamStats.get(modalTeam.name)?.spent ?? 0 : 0, hidePurse: rules.lotteryMode, onClose: () => setModalTeam(null) }),
